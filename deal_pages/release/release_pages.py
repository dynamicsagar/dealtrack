...
class ReleasePages(SeleniumDriver):
    ...
    release_to_d_button = "//button[contains(text(),'Release to D')]"
    ...
    add_floor_button_after_release = "//button[contains(text(),'Add floors')]"
    ...
    def ReleaseEToD(self):
        ...
        time.sleep(2)
        add_floor = "Add floors"
        addFloor = self.getText(self.add_floor_button_after_release)
    ...
    button_request_release_to_c = "//button[contains(text(),'Request release to C')]"
    ...
    def AddFloors(self):
        time.sleep(3)
        self.elementClick(self.add_floor_button_after_release)
        time.sleep(2)
        ...
        verify_button_text = "Request release to C"
    ...
    next_button_step2 = "//div[3]/button"
    ...
    def ReleaseDToCForm(self):
        ...
        self.dealdetail.SubmitButton()
        time.sleep(8)
        verify_deal_after_completion = self.getText(self.cancel_button_for_verification)
        text_verify = "Cancel"
    ...
    button_request_release_to_b = "//button[contains(text(),'Request release to B')]"
    ...
    def ReleaseCToB(self):
        ...
        button_text = "Move to B"
        self.verifyTextContains(actualText=button, expectedText=button_text)


    move_to_b_button = "//button[contains(text(),'Move to B')]"
    button_release = "//button[contains(text(),'Release')]"
    release_to_a_button = "//button[contains(text(),'Request release to A')]"
    ...
    def ReleasePopUpFieldEntry(self):
        ...
        time.sleep(2)
        self.elementClick(self.select_value_real_state_manager_vineet)
